...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className='relative rounded-full boder dark:bg-black dark:border-white/[0.2] border-2 border-orange-400 border-opacity-50 shadow-input flex justify-center space-x-4 px-8 py-6'
    >
      {children}
    </nav>
  )
